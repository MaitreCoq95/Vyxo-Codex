...
import { getUserXP, calculateLevelProgress, xpNeededForNextLevel } from "@/domain/codex/xp-system";
import { UserXP } from "@/domain/types/codex";
import { badges } from "@/domain/codex/learningPaths";
