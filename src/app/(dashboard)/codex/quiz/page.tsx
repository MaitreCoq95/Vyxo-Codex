...
import { getAllRandomQuestions, getAllQuestionsByModule } from "@/domain/codex/all-questions";
import { getModuleById } from "@/domain/codex/modules";
import { QuizRunner } from "@/components/codex/quiz-runner";
import { saveQuizResults } from "@/domain/codex/scoring-system";
import { recordQuizCompleted } from "@/domain/codex/xp-system";
...
import { QuizQuestion, QuizResult } from "@/domain/types/codex";
