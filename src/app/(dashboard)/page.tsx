...
export default function DashboardPage() {
  ...
  const stats = {
    ...
    categories: Array.from(new Set(knowledgeModules.map((m) => m.category)))
      .length,
  };
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Votre base de connaissances pour maîtriser les normes ISO, GDP, GMP,
            CEIV et l'excellence opérationnelle.
          </p>
        </div>
